...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    {
        return $this->merge(ws_collect($input)->filter(function ($value, $key) {
     ...
     *
     * @param  \WpStarter\Http\Request  $from
     * @param  \WpStarter\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an WpStarter request from a Symfony instance.
     *
     ...
     * Get the session associated with the request.
     *
     * @return \WpStarter\Session\Store|null
     */
     ...
     *
     * @param  \WpStarter\Contracts\Session\Session  $session
     * @return void
     */
     ...
     * @param  mixed  $default
     * @return \WpStarter\Routing\Route|object|string|null
     */
