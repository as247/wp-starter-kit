...
class Application extends Container implements ApplicationContract, CachesConfiguration, CachesRoutes, HttpKernelInterface
{
     ...
     *
     * @param  \WpStarter\Support\ServiceProvider|string  $provider
     * @param  bool  $force
     * @return \WpStarter\Support\ServiceProvider
     */
     ...
     *
     * @param  \WpStarter\Support\ServiceProvider|string  $provider
     * @return \WpStarter\Support\ServiceProvider|null
     */
     ...
     *
     * @param  \WpStarter\Support\ServiceProvider  $provider
     * @return void
     */
    ...
    public function registerCoreContainerAliases()
    {
        foreach ([
            ...
            'config' => [\WpStarter\Config\Repository::class, \WpStarter\Contracts\Config\Repository::class],
            ...
            'filesystem' => [\WpStarter\Filesystem\FilesystemManager::class, \WpStarter\Contracts\Filesystem\Factory::class],
            'filesystem.disk' => [\WpStarter\Contracts\Filesystem\Filesystem::class],
            ...
            'redirect' => [\WpStarter\Routing\Redirector::class],
            'redis' => [\WpStarter\Redis\RedisManager::class, \WpStarter\Contracts\Redis\Factory::class],
            'redis.connection' => [\WpStarter\Redis\Connections\Connection::class, \WpStarter\Contracts\Redis\Connection::class],
            'request' => [\WpStarter\Http\Request::class, \Symfony\Component\HttpFoundation\Request::class],
